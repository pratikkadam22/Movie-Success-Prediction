<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blackmail.aspx.cs" Inherits="blackmail" %>
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
          ...
          <h4 style="color:white;font-family:'Arial Black';">Blackmail</h4><form id="form1" runat="server"><asp:Button ID="btnHome" onclick="btnHome_Click" runat="server" style="position:absolute;top:0px;right:-60px;" class="btn btn-primary" Text="HOME"/></div>
          <iframe width="800" height="450" src="https://www.youtube.com/embed/aPpLOfK_Z3A" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
        </div>
 
        <div class="row">
        <div class="col-sm-4 col-md-4">
           <p style="color:white;font-size:15;"><b>Release Date:</b> 6 April 2018</p>
           <p style="color:white;font-size:15;"><b>Director:</b> Abhinay Deo</p>
           <p style="color:white;font-size:15;"><b>Starring:</b> Irrfan Khan </p>
           <p style="color:white;font-size:15;"><b>Genre:</b> Comedy  </p>

<a class="btn btn-block btn-social btn-facebook" style="background:#3B5998;color:white;" href="https://www.facebook.com/irrfanofficial/">
    <span class="fa fa-facebook"></span> Like on Facebook
  </a>
<a class="btn btn-block btn-social btn-twitter" style="background:#3498DB;color:white;"https://twitter.com/BlackmailFilm?lang=en">
...
<a class="btn btn-block btn-social " target = "_blank" style="background:#edf3b3;color:black;" href="https://tools.wmflabs.org/pageviews/?project=en.wikipedia.org&platform=all-access&agent=user&range=last-month&pages=102_Not_Out">
    ...
    <div class="row">
        <div class="col-md-4 text-center">
                 <asp:Button ID="btnSubmit2" runat="server" OnClientClick="window.open('http://movie.localtunnel.me/movies/blackmail/twitter.php');return false;" class="btn-lg btn-primary " style="position:relative;top:75px;left:100px;" Text="Social Review"/>
           </div>
