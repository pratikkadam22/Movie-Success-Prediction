<%@ Page Language="C#" AutoEventWireup="true" CodeFile="october.aspx.cs" Inherits="october" %>
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <img src="img/m13-1.jpg" height="475" width="320"
            alt="" class="img-rounded img-responsive" />
        </div>
          <div class="col-md-8"><div class="row">
          <h4 style="color:white;font-family:'Arial Black';">October</h4><form id="form1" runat="server"><asp:Button ID="btnHome" onclick="btnHome_Click" runat="server" style="position:absolute;top:0px;right:-60px;" class="btn btn-primary" Text="HOME"/></div>
          <iframe width="800" height="450" src="https://www.youtube.com/embed/7vracgLyJwI" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
        </div>
 
        <div class="row">
        <div class="col-sm-4 col-md-4">
           <p style="color:white;font-size:15;"><b>Release Date:</b> 13 April 2018</p>
           <p style="color:white;font-size:15;"><b>Director:</b> Shoojit Sircar</p>
           <p style="color:white;font-size:15;"><b>Starring:</b> Varun Dhawan</p>
           <p style="color:white;font-size:15;"><b>Genre:</b> Drama, Romance  </p>

<a class="btn btn-block btn-social btn-facebook" style="background:#3B5998;color:white;" href="https://www.facebook.com/OctoberFilm2018/">
    <span class="fa fa-facebook"></span> Like on Facebook
  </a>
<a class="btn btn-block btn-social btn-twitter" style="background:#3498DB;color:white;"https://twitter.com/OctoberFilm2018?lang=en">
    <span class="fa fa-twitter"></span> Follow on Twitter
  </a>
<a class="btn btn-block btn-social " target = "_blank" style="background:#edf3b3;color:black;" href="https://tools.wmflabs.org/pageviews/?project=en.wikipedia.org&platform=all-access&agent=user&range=last-month&pages=October_(2018_film)">
    ...
    <div class="row">
        <div class="col-md-4 text-center">
                 <asp:Button ID="btnSubmit2" runat="server" OnClientClick="window.open('http://movie.localtunnel.me/movies/october/twitter.php');return false;" class="btn-lg btn-primary " style="position:relative;top:75px;left:100px;" Text="Social Review"/>
           </div>
